...
export default function AnonymousReport({ navigation }) {
  ...
  const onPressPost = async () => {
    if (subject.length < 3 || containsSpecialChars(subject)) {
      ...
      firebase
        ...
        const ref = firebase.storage().ref().child(`AnonymousReport/${reportId}`)
  ...
  return (
    <Layout>
      <Header navigation={navigation} title="Anonymous Report" />
      {isDone ? (
        <CheckMark />
      ) : (
        <>
        <View style={{flexDirection:"row", alignItems: "center",}}>
            <View style={{marginTop:15, marginRight:10}}>
                <MaterialIconsI name="subject" size={30} color="#407ad6" />
            </View>
          ...
          <View style={{flexDirection:"row", alignItems:"center", justifyContent:"center",  }}>
            <View style={{marginTop:15, marginRight:10}}>
                <MaterialCommunityIcons name="message-flash-outline" size={30} color="#407ad6" style={{ position: "relative",}} />
            </View>
            ...
            <View>
                <InputBox                   
                    ...
                    multiline={true}
                    customLabelStyle={styles.inputText}
                    inputboxStyle={[styles.inputStyle, {minHeight: DEVICE_HEIGHT * 0.13,}]}
